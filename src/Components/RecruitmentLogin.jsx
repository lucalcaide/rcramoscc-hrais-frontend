...
const RecruitmentLogin = () => {
  ...
  const handleSubmit = (event) => {
    ...
    axios.post('http://localhost:3000/recruitment/recruitmentlogin', values)
      .then(result => {
        if (result.data.loginStatus) {
          navigate('/recruitmentdashboard/terms_and_agreements');
        } else {
        ...
        <div className='p-3 rounded w-30 border-0'>
          ...
          <div className="text-center">
            ...
            <p className="mt-3" style={{ fontSize: '18px', fontFamily: 'Montserrat', fontStyle: 'italic' }}>
              You are logging in as <span style={{ fontWeight: 'bold', fontStyle: 'italic' }}>recruitment</span>
            </p>
          ...
          <form className="d-flex flex-column align-items-center" onSubmit={handleSubmit}>
            ...
            <button className='btn btn-success w-50 rounded-2 mb-2' style={{ fontSize: '18px', fontFamily: 'Montserrat' }}>Login</button>
          </form>
